...
The live website version of this guidance is hosted at [https://inspect-sr.com](https://inspect-sr.com). The original address, [https://inspect.sr](https://inspect.sr), also works and redirects here — both are maintained permanently, but `inspect-sr.com` is preferred, as some institutional networks block the `.sr` domain.

A pdf of the website is also hosted on OSF ([https://osf.io/b74wj/](https://osf.io/b74wj/)).
...
Technically, this guidance website and its GitHub repository has its own DOI and is archived on Zenodo. However, please cite the publication itself, above.

::: {.content-visible when-format="html"}
[![](https://zenodo.org/badge/DOI/10.5281/zenodo.21905597.svg){fig-alt="DOI"}](https://doi.org/10.5281/zenodo.21905597)
:::
