...
- [INSPECT-SR granularity and bounds consistency checker for means and variances](https://errors.shinyapps.io/inspect-sr-means-variances/) — Lukas Jung and Ian Hussey's web app for checking multiple values with GRIM and GRIMMER, with guidance on interpretation and the ability to download a copy of the results. Note that this web simultaneously applies INSPECT-SR check 4.10: bounds checks. Built on Lukas Jung's ['scrutiny'](https://lhdjung.github.io/scrutiny/) R package and Ian Hussey's ['strait'](https://github.com/ianhussey/strait/) R package.
- [scrutiny web app](https://errors.shinyapps.io/scrutiny/) — Lukas Jung's more advanced web app for testing multiple values with GRIM and GRIMMER, plus diagnostics. Built on Lukas Jung's ['scrutiny'](https://lhdjung.github.io/scrutiny/) R package. 
