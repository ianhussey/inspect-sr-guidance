...
- [recalc web app](https://errors.shinyapps.io/recalc_independent_t_test/) — assess whether reported effect sizes can be reproduced from reported summary statistics
